...
| Automate daily and weekly tasks | [Routines & Scheduled Tasks](workflows/routines.md) |
...
| [Routines](workflows/routines.md) | Daily, weekly, and event-triggered scheduled automations |
