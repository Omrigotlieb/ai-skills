...
<p align="center">
  <a href="routines/README.md"><strong>New: Routines — Cloud Automation Templates →</strong></a>
</p>
...
| Automate with cloud routines | [Routines](routines/README.md) — scheduled, API, and GitHub-triggered |
...
| [Routines](routines/README.md) | Cloud automation templates — standup, triage, review, deploy, and more |
